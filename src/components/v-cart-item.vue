    ...
    <div class="cart-item">
        ...
        <div class="cart-item__quantity">
            <div class="cart-item__quantity__btns">
                <button
                    class="quantity"
                    @click="$store.commit('decrease', product)"
                >
                    -
                </button>
                ...
                <button
                    class="quantity"
                    @click="$store.commit('increase', product)"
                >
                    +
                </button>
            </div>
        ...
        <b class="cart-item__priceRub"
            >{{
                $store.state.cart.reduce(
                    (acc, cur) => (acc += cur.priceRub * cur.quantity),
                    0
                )
            }}
            ₽</b
        ...
        <div
            ...
            @click="$store.commit('deleteProductToCart', product)"
        >
            X
        </div>
    </div>
